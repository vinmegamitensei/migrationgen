  ...
  return (
    <>
      ...
      <div className="fixedFooter">
        <Container>
          <button onClick={() => downloadJava(taskOwner, taskCode, namespace)} className="buttonContainer">
            Download Java File
          </button>
          <button onClick={() => downloadJSON(taskCode, messages, namespace)} className="buttonContainer">
            Download JSON File
          </button>
          <button onClick={() => downloadZipFile({owner: taskOwner, taskCode, namespace, messages})}>
            Download .Zip File
          </button>
        </Container>
      </div>
